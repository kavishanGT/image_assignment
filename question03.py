...
# Load images
architecture_image = opencv.imread('Images/005.jpg')  # Replace with your architectural image
national_flag_image = opencv.imread('Images/flag.png')  # Replace with your flag image
...
opencv.fillConvexPoly(masking_image, np.int32(building_corners), (10, 10, 10))
